...
中信证券 VP,此前在腾讯微信支付做基础架构。
做的事情基本在同一个位置上:前沿 ML 真正落到生产系统的那一层 —— 金融、电网、通信,以及底下支撑它们的分布式系统。

#### 经历

- **中信证券** — VP。大模型、Agent、面向工业系统的联邦学习
- **腾讯 · 微信支付** (2019–2024) — 基础架构。生活缴费、支付分、混沌工程
- **阿里巴巴** (实习) — 大文娱、阿里妈妈 (2016–2017),阿里健康 (2018)

#### 当前研究方向

- **大模型** — 预训练、后训练 (SFT / RLHF / RLVR)、强化学习、深度学习
- **Agent 与 AI 产品** — Agent 架构,以及把它做成真能上线的产品
- **联邦学习** — 数据不能汇总的机构之间做隐私保护训练
- **落地领域** — 电网(故障诊断、知识图谱)、6G、量化金融

#### 技术栈

Java · Go · Scala · Python · Flink / Spark / Kafka · Kubernetes
...
- [**eshop**](https://github.com/zengxiaosen/eshop) — 电商平台,含 Spark ML 管线
- [**Cloud-LLM**](https://github.com/zengxiaosen/Cloud-LLM) — 云计算与 SDN 的论文与笔记
- [**kafka-fault-tolerant**](https://github.com/zengxiaosen/kafka-fault-tolerant) — Kafka 元数据一致性,Spark → Oracle
...
[![百度学术](https://img.shields.io/badge/百度学术-作者主页-2932E1)](https://xueshu.baidu.com/s?wd=author%3A%28%E6%9B%BE%E6%99%93%E6%A3%AE%29)
